...
from keras.layers import Input, Conv1D, Dense, Flatten, Dropout, MaxPooling1D, GlobalMaxPooling1D, Activation, BatchNormalization
...
def loaddata(WINDOW_SIZE):    
    ...
    y = np.loadtxt('./data/y_train.csv', dtype='int', delimiter=' ')
    # Merging datasets    
